...
from earthmover.refactor.operations import row as row_operations, groupby as groupby_operations, \
    dataframe as dataframe_operations, column as column_operations
...
class Operation:
    ...
    def __new__(cls, config, *, earthmover: Earthmover):
        ...
        operation_class = cls.OPERATION_MAPPING.get(operation)
